 ...
 *
 * The title stays attached to that week forever once earned (see the ranking history page), but
 * this resolver additionally surfaces the *current* holder so their name can be decorated with it
 * everywhere else in the app, until the next week's winner supersedes them.
 *
