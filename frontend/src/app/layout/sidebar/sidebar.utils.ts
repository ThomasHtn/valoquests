import { PlayerSynchronizationStatus } from '../../core/players/player-summary.model';

/**
 * Resolves the most recent successful synchronization among `players`.
 *
 * @param players - Tracked players' synchronization statuses.
 ...
 */
export function resolveLatestSynchronization(
  players: readonly PlayerSynchronizationStatus[],
): string | null {
